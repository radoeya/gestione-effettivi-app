document.addEventListener('DOMContentLoaded', function() {
    // --- INIZIALIZZAZIONE ---
    // Questa chiamata ora funziona perché lo script viene eseguito dopo che la libreria lucide è stata caricata.
    lucide.createIcons();
    ...
    if (!generateReportBtn || !modal || !calendarEl) {
        console.error("Elemento HTML critico non trovato. Controllare gli ID in index.html.");
        alert("Errore di inizializzazione: un elemento della pagina non è stato trovato.");
        return;
    }
